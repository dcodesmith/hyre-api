...
export const statusCodeMap: Record<string, number> = {
  ...
  BOOKING_CANNOT_BE_ACTIVATED: HttpStatus.BAD_REQUEST,
  BOOKING_CANNOT_BE_COMPLETED: HttpStatus.BAD_REQUEST,
  INVALID_BOOKING_TIME: HttpStatus.BAD_REQUEST,
  INVALID_BOOKING_PERIOD: HttpStatus.BAD_REQUEST,
  INVALID_PAYMENT_STATUS: HttpStatus.BAD_REQUEST,
  PAST_BOOKING_TIME: HttpStatus.BAD_REQUEST,
  SAME_DAY_RESTRICTION: HttpStatus.BAD_REQUEST,
  BOOKING_TIME_CONFLICT: HttpStatus.CONFLICT,
  DRIVER_NOT_AVAILABLE: HttpStatus.CONFLICT,
  CAR_OWNER_ID_REQUIRED_FOR_FLEET_OWNER_VERIFICATION: HttpStatus.BAD_REQUEST,
  BOOKING_CUSTOMER_NOT_AUTHORIZED: HttpStatus.BAD_REQUEST,
  GUEST_CUSTOMER_DETAILS_REQUIRED: HttpStatus.BAD_REQUEST,
  ...
  CAR_NOT_APPROVED: HttpStatus.BAD_REQUEST,
  CAR_IN_SERVICE: HttpStatus.CONFLICT,
  CAR_OWNER_NOT_FOUND: HttpStatus.NOT_FOUND,
  INVALID_CAR_RATES: HttpStatus.BAD_REQUEST,
